...
function SortableComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragover", function SortableComponent_div_1_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r92); const ctx_r91 = ɵngcc0.ɵɵnextContext(); return ctx_r91.onItemDragover($event, 0); })("dragenter", function SortableComponent_div_1_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r92); const ctx_r93 = ɵngcc0.ɵɵnextContext(); return ctx_r93.cancelEvent($event); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r87 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r87.placeholderClass)("ngStyle", ctx_r87.placeholderStyle);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r87.placeholderItem);
} }
...
function SortableComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragstart", function SortableComponent_div_2_Template_div_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r98); const item_r94 = ctx.$implicit; const i_r95 = ctx.index; const ctx_r97 = ɵngcc0.ɵɵnextContext(); return ctx_r97.onItemDragstart($event, item_r94, i_r95); })("dragend", function SortableComponent_div_2_Template_div_dragend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r98); const ctx_r99 = ɵngcc0.ɵɵnextContext(); return ctx_r99.resetActiveItem($event); })("dragover", function SortableComponent_div_2_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r98); const i_r95 = ctx.index; const ctx_r100 = ɵngcc0.ɵɵnextContext(); return ctx_r100.onItemDragover($event, i_r95); })("dragenter", function SortableComponent_div_2_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r98); const ctx_r101 = ɵngcc0.ɵɵnextContext(); return ctx_r101.cancelEvent($event); });
    ...
    const _r89 = ɵngcc0.ɵɵreference(4);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(5, _c0, ctx_r88.itemClass, i_r95 === ctx_r88.activeItem ? ctx_r88.itemActiveClass : ""))("ngStyle", ctx_r88.getItemStyle(i_r95 === ctx_r88.activeItem));
    ɵngcc0.ɵɵattribute("aria-grabbed", i_r95 === ctx_r88.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r88.itemTemplate || _r89)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c1, item_r94, i_r95));
} }
function SortableComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const item_r102 = ctx.item;
    ɵngcc0.ɵɵtextInterpolate(item_r102.value);
} }
